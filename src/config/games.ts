...
export const games: Game[] = [
  {
    ...
    "enabled": true,
    "interactive": true,
    "seoTitle": "Poker Equity Calculator & Odds Trainer \u2014 Exact, Not Estimated",
    "metaDescription": "Work out exact Texas Hold'em equity by full enumeration, see your real outs rather than the rule-of-2-and-4 guess, and check whether a call is +EV. Runs in your browser.",
    ...
    "seoContent": "## Exact, not estimated\n\nMost equity tools sample: they deal a few hundred thousand random runouts and report the average. That is fast and it is approximately right. This one enumerates **every** legal runout and counts, so the number you see is the number \u2014 reproducible to the last decimal, with no confidence interval to caveat.\n\nA flop is 990 runouts and a turn is 44, both instant. A preflop spot is 1,712,304, which is too many to enumerate in a browser without a wait \u2014 so the trainer refuses that one and says why, rather than quietly switching to sampling while looking exactly the same.\n\n## Outs, and why the shortcut lies to you\n\nEveryone is taught the rule of 2 and 4: count your outs, multiply by 2 for one card to come or 4 for two. It is a good shortcut and it is **systematically optimistic**, because it ignores that some of your outs also improve your opponent.\n\nSo the trainer shows both. The actual out cards, the count, the shortcut's estimate, and the exact equity side by side \u2014 the gap between the last two is the part nobody shows you.\n\n## Pot odds as two separate numbers\n\nThe required equity for a call and your actual equity are computed independently and displayed as a comparison, not collapsed into a single \"you should call\" verdict. The arithmetic is the thing worth learning; a verdict that hides it teaches nothing.\n\nThe EV figure assumes the hand goes to showdown with no further betting \u2014 the assumption every pot-odds lesson makes silently, stated here rather than implied.\n\n## Privacy\n\nEverything runs in your browser. No account, no upload, no stored hands."
  },
  {
    "slug": "2048",
    "title": "2048",
