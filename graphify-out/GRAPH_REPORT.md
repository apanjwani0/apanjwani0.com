# Graph Report - portfolio-apanjwani0  (2026-08-02)

## Corpus Check
- 96 files · ~124,992 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1593 nodes · 3274 edges · 72 communities (62 shown, 10 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 40 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2ee23428`
...
7. `LSystemGame` - 30 edges
8. `EpochWizardTool` - 30 edges
9. `HashSmithTool` - 29 edges
10. `MurmurationGame` - 28 edges
...
Cohesion: 0.10
Nodes (23): ../../components/games/wallpaper-forge/WallpaperForge.ts, AspectId, clamp(), fade(), fbm(), hash2(), lerp(), mix() (+15 more)

### Community 30 - "Community 30"
Cohesion: 0.12
Nodes (6): createPbSession(), clamp(), makeInviteCode(), makeSeed(), PokerGame, iconSvg()
...
Cohesion: 0.07
Nodes (29): breadcrumbLd, crumbs, ldJson, post, ../../components/Breadcrumbs.astro, blogPostingJsonLd(), BlogPostingSchema, BreadcrumbEntry (+21 more)
...
Cohesion: 0.15
Nodes (15): ExperienceItem Props, ../components/ProjectCard.astro, ProjectCard Props, GitHubStats, itemListJsonLd(), render(), renderInline, renderInline() (+7 more)
...
Cohesion: 0.09
Nodes (23): cardLabel(), cryptoInt(), shuffle(), ActionType, BotsAPI, Card, CATEGORY_NAME, EvaluatorAPI (+15 more)
...
Cohesion: 0.15
Nodes (23): ALL_RANKS, buildRemainingDeck(), cardKey(), decide(), estimateEquity(), makeRng(), PersonalityProfile, PROFILES (+15 more)
...
Cohesion: 0.16
Nodes (16): hashSeed(), Account, API_BASE, apiHealth(), currentUser(), idEmail(), login(), logout() (+8 more)
...
Cohesion: 0.11
Nodes (17): breadcrumbLd, crumbs, game, ldJson, liveGame, ../../components/games/flow-field/flow-field.css, ../../components/games/game-of-life/game-of-life.css, ../../components/games/games-common.css (+9 more)
...
## Knowledge Gaps
- **389 isolated node(s):** `name`, `type`, `version`, `node`, `dev` (+384 more)
...
- **Why does `../../components/tools/pattern-forge/PatternForge.ts` connect `Admin API Route Handlers (login/logout/save)` to `Community 36`?**
  _High betweenness centrality (0.176) - this node is a cross-community bridge._
- **Why does `Rng` connect `Admin API Route Handlers (login/logout/save)` to `Community 56`, `Community 42`, `Community 4`, `Community 47`?**
  _High betweenness centrality (0.150) - this node is a cross-community bridge._
- **Why does `v()` connect `Layout Shell (Base + ToolBase + Head + Nav)` to `Community 32`, `Community 35`, `Community 4`, `Community 173`, `Community 45`, `Community 175`, `Community 25`, `Community 29`?**
